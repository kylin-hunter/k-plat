...
public class ConfigurationsForDefaultController extends ConfigurationsForDefault {
    public ConfigurationsForDefaultController(@NonNull ConfigurationsCustomize configurationsCustomize) {
        super(configurationsCustomize);
