...
public class ConfigurationsForCSKBController extends ConfigurationsForCSKB {
    public ConfigurationsForCSKBController(@NonNull ConfigurationsCallback configurationsCallback) {
        super(configurationsCallback);
