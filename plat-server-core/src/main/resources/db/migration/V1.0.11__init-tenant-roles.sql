...
INSERT INTO kplat_tenant_role_permission (id, sys_tenant_id, sys_auto_updated, sys_created_user_id,
                                   ...
                                   sys_op_lock,
                                   role_id, permission_id)
VALUES ('1002', '1', CURRENT_TIMESTAMP, '1', 'admin', CURRENT_TIMESTAMP, '1', 'admin',
...
INSERT INTO kplat_tenant_role_permission (id, sys_tenant_id, sys_auto_updated, sys_created_user_id,
                                   ...
                                   sys_op_lock,
                                   role_id, permission_id)
VALUES ('1003', '1', CURRENT_TIMESTAMP, '1', 'admin', CURRENT_TIMESTAMP, '1', 'admin',
...
INSERT INTO kplat_tenant_role_permission (id, sys_tenant_id, sys_auto_updated, sys_created_user_id,
                                   ...
                                   sys_op_lock,
                                   role_id, permission_id)
VALUES ('1004', '1', CURRENT_TIMESTAMP, '1', 'admin', CURRENT_TIMESTAMP, '1', 'admin',
