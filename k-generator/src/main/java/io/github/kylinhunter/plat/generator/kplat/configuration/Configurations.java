...
public class Configurations {
  ...
  public void initPackageConfig(PackageConfig packageConfig) {
    ...
    packageConfig.setPackagePattern(
        Template.SERVICE_INTERCEPTOR_SAVE_UPDATE, "%s.service.local.interceptor");
    packageConfig.setPackagePattern(
        Template.SERVICE_INTERCEPTOR_DELETE, "%s.service.local.interceptor");
