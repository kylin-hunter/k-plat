...
public class TemplateConfig {
  private static final String DEFAULT_TEMPLATE_REQ_VO_CREATE =
      "/generator/templates/req_vo_create.java";
  private static final String DEFAULT_TEMPLATE_REQ_VO_UPDATE =
      "/generator/templates/req_vo_update.java";
  private static final String DEFAULT_TEMPLATE_RESP_VO_RESPONSE =
      "/generator/templates/resp_vo.java";
  private static final String DEFAULT_TEMPLATE_RESP_VO_REQ_QUERY =
      "/generator/templates/req_vo_query.java";
  private static final String DEFAULT_TEMPLATE_RESP_VO = "/generator/templates/vo.java";
  private static final String DEFAULT_TEMPLATE_SERVICE_LOCAL =
      "/generator/templates/service_local.java";
  private static final String DEFAULT_TEMPLATE_SERVICE_LOCAL_IMP =
      "/generator/templates/service_local_imp.java";
  ...
  private static final String DEFAULT_SERVICE_INTERCEPTOR_DELETE =
      "/generator/templates/service_interceptor_delete" + ".java";
  private static final String DEFAULT_TEMPLATE_SERVICE_RPC =
      "/generator/templates/service_rpc.java";
  private static final String DEFAULT_TEMPLATE_SERVICE_RPC_IMP =
      "/generator/templates/service_rpc_imp.java";
  ...
  public void setEnabled(TemplateType templateType, boolean enabled) {
    Arrays.stream(Template.values())
        .filter(t -> t.getType() == templateType)
