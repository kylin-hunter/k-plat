...
CREATE TABLE IF NOT EXISTS `kp_user` (
    ...
    `sys_created_user_id` varchar(64) NOT NULL COMMENT '创建人userid',
    `sys_created_user_name` varchar(64) NOT NULL COMMENT '创建人username',
    `sys_created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `sys_update_user_id` varchar(64) NULL COMMENT '最后编辑人userid',
    `sys_update_user_name` varchar(64) NULL COMMENT '最后编辑人username',
    `sys_update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后编辑时间',
